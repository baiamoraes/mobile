  ...
  return (
    <View style={styles.container}>
      <Image
        ...
        resizeMode="contain"  
      />
      <Text style={styles.title}>O dólar americano está:</Text>
      {loading ? <ActivityIndicator size="large" /> : <Text style={styles.value}>R$ {parseFloat(cotacao.USD).toFixed(2)}</Text>}
